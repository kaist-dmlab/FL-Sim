...
class Model(AbstractModel):
    ...
    def get_logits_cnn(self, x, W_conv1, b_conv1, W_conv2, b_conv2, W_conv3, b_conv3, W_conv4, b_conv4, W_conv5, b_conv5, W_fc1, b_fc1, W_fc2, b_fc2):
...
#         h_fc1_drop = tf.nn.dropout(h_fc1, keep_prob)
    ...
    def createModel(self):
        ...
        logits = self.get_logits_cnn(self.x, W_conv1, b_conv1, W_conv2, b_conv2, W_conv3, b_conv3, W_conv4, b_conv4, W_conv5, b_conv5, W_fc1, b_fc1, W_fc2, b_fc2)
